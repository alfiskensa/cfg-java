...
public class Permission {
    ...
    private static final List<String> PROTECTION_NORMAL = new ArrayList<String>(Arrays.asList(
    ...
    private static final List<String> DANGEROUSE_PERMISSIONS = new ArrayList<String>(Arrays.asList(
            "READ_CALENDAR",
            "WRITE_CALENDAR",
            "CAMERA",
            "READ_CONTACTS",
    ...
    private static final List<String> PROTECTION_SIGNATURE = new ArrayList<String>(Arrays.asList(
